...
class HashMapRobinHoodNode {
 public:
  ...
  static const std::string name() { return "RH Node Map"; }

  static IndexType type() { return IndexType::RobinHoodNodeMap; }
 ...
 protected:
  robin_hood::unordered_node_map<Key, Value> _map;
};

...
class HashMapTslSparse {
 public:
  ...
  static const std::string name() { return "TSL Sparse Map"; }

  static IndexType type() { return IndexType::SparseMapTSL; }
